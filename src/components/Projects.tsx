          ...
          return (
            ...
            >
              <div className="flex items-center">
                <img
                  src={project.img}
                  className="md:max-w-56 w-full md:h-32 h-40 rounded-sm object-cover"
                  alt={project.title}
                />
              </div>
              ...
              <div className="flex flex-col gap-2 bg-[#1B1B1D]">
                <div className="flex flex-col ">
                  <span className="text-xl font-bold bg-[#1B1B1D]">{project.title}</span>
                ...
                <div className="flex gap-3 bg-[#1B1B1D] ">
                  {project.stack.map((stack, id) => {
                    return (
                      <div key={id} className="p-1  text-sm rounded-sm bg-[#1B1B1D] text-gray-400 cursor-pointer">
